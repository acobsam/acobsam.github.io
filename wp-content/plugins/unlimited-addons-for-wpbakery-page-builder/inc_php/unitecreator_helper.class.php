 ...
 */
	class HelperUC extends UniteHelperBaseUC{
		 ...
		 * get some object url
		 */
		private static function getUrlViewObject($view, $objectID, $optParams){
			...
			return(self::getViewUrl($view, $params));
		}
		...
		public static function getViewUrl_Layout($layoutID = null, $optParams = ""){
			...
			return self::getUrlViewObject(GlobalsUC::VIEW_LAYOUT, $layoutID, $optParams);
		}
